...
<meta name="description" content="질문 게시글 수정">
		...
		<table border="1px" align="center" width="400px" cellpadding="5px">
			<tr>
				<td align="center" height="20px"><input type="text"
					...
					required="required" style="height: 30px" class="info" value="${dto.qTitle}"></td>
			</tr>
		
			<tr>
				<td align="left" height="20px"><input type="button" value="파일 선택">${dto.qImg}<p style="color: red;">이미지는 보안상의 이유로 수정이 불가능합니다.</p></td>
			</tr>
			
			<tr>
				<td><textarea name="qContent" id ="qContent" cols="100" rows="30"
						placeholder="내용을 입력해주세요." required="required" class="info">${dto.qContent}</textarea></td>
			</tr>
			<tr align="right">

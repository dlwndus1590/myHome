...
<!--New Products -->
	...
	<hr class="soften"/>
		...
		<div id="newProductCar" class="carousel slide">
			...
			<div class="item active">
			  <ul class="thumbnails">
			  	<c:forEach var="categoryList" items="${categoryList1}" begin="0" end="3" step="1">
				<li class="span3">
				<div class="thumbnail">
					<a class="zoomTool" href="" title="add to cart"><span class="icon-search"></span>${categoryList.categoryName}</a>
					<a href=""><img src="${CONTEXT_PATH}/${categoryList.categoryImg}" style="height:200px;"></a>
		   ...
		   <div class="item">
		  <ul class="thumbnails">
		  	<c:forEach var="categoryList" items="${categoryList1}" begin="4" end="7" step="1">
			<li class="span3">
			  <div class="thumbnail">
				<a class="zoomTool" href="" title="add to cart"><span class="icon-search"></span>${categoryList.categoryName}</a>
				<a  href=""><img src="${CONTEXT_PATH}/${categoryList.categoryImg}" style="height:200px;"></a>

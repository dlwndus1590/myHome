...
<!-- contents menu -->
<form action="${CONTEXT_PATH}/member/memberController?action=sellerMyInfoUpdate"  method="post" style="padding-left:4%; height:1100px; width:960px;">
  ...
  <div class="container">
    ...
    <label><b>주소</b></label>
    <br>
    <input type="text" placeholder="Enter Zipcode" name="zipcode" id="zipcode" value="<%=dto.getZipcode() %>" readonly="readonly">
    ...
    <input type="text" placeholder=" '-'를 포함해서 입력해주세요. " name="businessNumber" id="businessNumber" pattern="\d{3}-\d{2}-\d{5}" maxlength="12" value="<%=dto.getBusinessNumber()%>" readonly="readonly">
    
    <label><b>회사/점포명</b></label>
    <input type="text" placeholder="Enter Company" name="companyName" id="companyName" value="<%=dto.getCompanyName()%>" readonly="readonly"> 

...
<div class="well well-small">
	<ul class="nav nav-list">
		<li><a href="products.html"><span class="icon-chevron-right"></span>가구/가전</a></li>
		<li><a href="products.html"><span class="icon-chevron-right"></span>패브릭</a></li>
		<li><a href="products.html"><span class="icon-chevron-right"></span>홈데코/조명</a></li>
		<li><a href="products.html"><span class="icon-chevron-right"></span>수납/정리</a></li>
		<li><a href="products.html"><span class="icon-chevron-right"></span>생활용품</a></li>
		<li><a href="products.html"><span class="icon-chevron-right"></span>주방</a></li>
	...
	<div class="well np">
		<div id="myCarousel" class="carousel slide homCar">
            <div class="carousel-inner">
              ...
              <div class="item">
                <img style="width:100%" src="${CONTEXT_PATH}/assets/img/bootstrap-templates.png" alt="bootstrap templates">
                <div class="carousel-caption">

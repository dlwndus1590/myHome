...
-- qnotice 초기화데이터
insert into qnotice values (1, '이거 어떻게 해결해야하나요', '답변 부탁드립니다.', '/img/qNotice/interior.jpg', 'user01', to_date('2021-04-20', 'yyyy-mm-dd'), 48);
...
그리고 눌린 부분을 다리미로 열을 가해 원상복구 시킬 수도 있을까요?', '/img/qNotice/maru.PNG', 'user01', to_date('2021-05-10', 'yyyy-mm-dd'), 87);
...
insert into interior values (3, '디자인바이세미콜론', 12, '깔끔하고 우아한 분위기의 인테리어를 만들어 낼 수 있습니다.', '서울시 보라매로 19길 39','010-9012-8524');
